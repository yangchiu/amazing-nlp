...
class NovelData():
    ...
    def get_corpus(self, save_dir, filename):
        ...
        # the `deep-nlp.max_length` limit. The limit is in number of characters, so you can check whether your inputs
        # are too long by checking `len(text)`.
        nlp.max_length = 1198623
        # corpus would be tokenized after deep-nlp() operation
